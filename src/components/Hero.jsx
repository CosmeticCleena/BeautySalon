  ...
  return (
    ...
    >
      <div className='flex flex-col items-center justify-center h-full'>
        <h1 className='text-white text-[48px] font-[600]'>Chào mừng đến với Cleena</h1>
        <p className='text-white text-[74px] font-[400] '><span className='text-[#D1AE62]'>Support for </span>a Calm and Relaxed Mind</p>
        <button className="text-[18px] font-bold border-white border-[1px] text-white px-5 py-2 mt-5 relative
