...
const SpaForm = ({ display }) => {
  ...
  return (
    <div
      className={`${display==="flex" ? "w-full" : ""} flex flex-col md:flex-row justify-center py-24`}
      id="form"
    >
      <div
        ...
        {display == "hidden" && (
          ...
          <div>
            <input
              ...
              className={`w-full border ${errors.name ? 'border-red-500' : 'border-[#D8D8D8]'} focus:border-[#D1AE62] p-3 placeholder:px-1`}
            />
            {errors.name && (
          ...
          <div>
            <input
              ...
              onChange={handleChange}
              className={`w-full border ${errors.email ? 'border-red-500' : 'border-[#D8D8D8]'} focus:border-[#D1AE62] p-3 placeholder:px-1`}
            />
            {errors.email && (
          ...
          <div>
            <input
              ...
              value={formData.date}
              onChange={handleChange}
              className={`w-full border ${errors.date ? 'border-red-500' : 'border-[#D8D8D8]'} focus:border-[#D1AE62] p-3 placeholder:px-1`}
            />
            {errors.date && (
        ...
        <div className="grid grid-rows-4 gap-5">
          <div>
            <select
              ...
              onChange={handleChange}
              className={`w-full border ${errors.service ? 'border-red-500' : 'border-[#D8D8D8]'} focus:border-[#D1AE62] p-3 placeholder:px-4 row-span-1`}
            >
