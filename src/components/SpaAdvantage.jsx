...
const SpaAdvantage = () => {
  return (
    <div className="flex w-3/5 mx-auto justify-center gap-24 py-24">
      <div className="flex-1 max-w-1/2">
        <img src={SpaTherapy} className="w-[600px] h-auto"></img>
      </div>
      <div className="flex flex-col flex-1 max-w-1/2 gap-12">
        <div>
